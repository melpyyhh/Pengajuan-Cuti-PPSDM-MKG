...
<div class="flex flex-col w-full">
    <!-- Title Section -->
    <div class="px-4 py-4">
        <h3 class="text-3xl font-bold tracking-wider text-black">Riwayat Pengaduan</h3>
    </div>
            ...
            <div class="bg-gray-100 p-2 rounded-xl border-2 border-[#0032CC] shadow-lg md:w-3/4 lg:w-2/3">
                ...
                <div class="flex-1 p-4 overflow-y-auto" style="max-height: 400px;">
                    ...
                    @if ($selectedPengaduan->status_pengaduan === 'ditanggapi')
                        <textarea type="text" id="tanggapan" wire:model="tanggapan" class="w-full p-2 mt-2 border rounded-lg" rows="6"
