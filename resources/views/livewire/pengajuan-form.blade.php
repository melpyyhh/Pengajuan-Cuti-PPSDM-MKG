    ...
    <div class="w-max-full mx-auto shadow sm:rounded-md sm:overflow-hidden h-auto">
        <div class="px-8 py-8 bg-[#F4F7FE] space-y-8 sm:p-8">
            @if ($currentPage === 1)
                ...
                <div>
                    <label for="jenisCuti" class="block text-sm font-medium text-gray-700">Jenis Cuti yang
                        diajukan:</label>
                    <select wire:model="selectedJenisCuti" id="jenisCuti"
            ...
            @elseif ($currentPage === 2)
                ...
                <div class="grid grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="alamatCuti" class="block text-sm font-medium text-gray-700">Alamat Selama
                                Cuti</label>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="nomorHp" class="block text-sm font-medium text-gray-700">Nomor
                                Handphone</label>
                            <input wire:model="nomorHp" type="text" id="nomorHp"
                                class="mt-1 block w-full rounded-xl border border-[#0032CC]">
                        </div>
                        <div>
                            <label for="tanggalMulai" class="block text-sm font-medium text-gray-700">Tanggal
                                Mulai</label>
