                ...
                <div class="flex items-center py-2 mb-5 space-x-4">
                    ...
                    <form action="{{ route('admin.daftar-pegawai') }}" method="GET" class="flex items-center flex-1">
                        <input type="text" name="search" id="search-input" placeholder="Cari..." 
                           class="flex-1 px-4 py-2 border rounded-l-md focus:outline-none max-w-[300px]" value="{{ request('search') }}">
                        ...
                        <tbody>
                            @forelse ($listPegawai as $data)
                                <tr class="odd:bg-white even:bg-gray-100 hover:bg-gray-100">
                                    <td class="px-10 py-4 text-center text-gray-800 text-s">{{ ($listPegawai->currentPage() - 1) * $listPegawai->perPage() + $loop->iteration }}</td>
                                        ...
                                        <div class="flex items-center justify-center">
                                            <a href="{{ route('admin.detail-pegawai', ['pegawaiId' => $data->id]) }}" 
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-6 h-6">
                                                    <path d="M11 2a9 9 0 1 1-6.32 15.34l-4.05 4.05a1 1 0 0 1-1.41-1.41l4.05-4.05A9 9 0 0 1 11 2zm0 2a7 7 0 1 0 4.95 11.95A7 7 0 0 0 11 4zm-1 3h2v3h3v2h-3v3h-2v-3H7v-2h3V7z"/>
                                                </svg>
                                            </a>
                                        </div>
                                    </td>
