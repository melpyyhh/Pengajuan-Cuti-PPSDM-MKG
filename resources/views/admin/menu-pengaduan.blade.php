<x-app-layout>
    ...
    <div class="flex flex-col w-full">
        <!-- Title Section -->
        <div class="px-4 py-4">
            <h3 class="text-3xl font-bold text-black tracking-wider">Daftar Pengaduan</h3>
        </div>

        <!-- Statistik Pengaduan -->
        <div class="grid grid-cols-3 gap-4 mb-6 px-4 max-w-full">
            <div class="bg-tertiary text-white text-center py-4 rounded-2xl">
        ...
        <div class="px-4">
            ...
            <div class="bg-blue-100 p-6 mb-2 rounded-md shadow-md flex justify-between">
                ...
                <button class="text-gray-800 font-bold px-2 py-1 h-auto leading-tight rounded-md transition-all hover:bg-tertiary hover:text-white">
                    Detail
                </button>
            </div>
            @endforeach
