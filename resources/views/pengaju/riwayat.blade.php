                    ...
                    <div class="overflow-hidden rounded-lg shadow">
                        <table class="w-full table-auto divide-y divide-gray-200 mx-auto ">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-16 py-10 text-start text-xs font-bold text-black uppercase tracking-widest">No</th>
                                    <th scope="col" class="px-16 py-10 text-start text-xs font-bold text-black uppercase tracking-widest">Tanggal Pengajuan</th>
                                    <th scope="col" class="px-16 py-10 text-start text-xs font-bold text-black uppercase tracking-widest">Jenis Cuti</th>
                                    <th scope="col" class="px-16 py-10 text-xs font-bold text-black uppercase tracking-widest">Lama Cuti</th>
                                    <th scope="col" class="px-16 py-10 text-xs font-bold text-black uppercase tracking-widest">Status</th>
                                    <th scope="col" class="px-16 py-10 text-xs font-bold text-black uppercase tracking-widest">Detail</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr class="odd:bg-white even:bg-gray-100 hover:bg-gray-100">
                                    ...
                                    <td class="px-16 py-10 text-xs text-gray-800">{{ $cuti->cuti->name ?? '-' }}</td>
                                    <td class="px-16 py-10 text-xs text-gray-800">{{ $cuti->lama_cuti }} Hari</td>
                                    <td class="px-16 py-10 text-xs text-gray-800">
                                        <span class=" 
                                                    @if(strtolower($cuti->status_ajuan) == 'diproses')
                                                        p-1.5 bg-yellow-200 text-yellow-700 uppercase font-bold text-wider rounded-xl
                                                    ...
                                                    @else 
                                                        p-1.5 bg-gray-200 text-gray-700
                                                    @endif
                                                ">
                                    ...
                                    <td class="px-16 py-10 text-left text-xs">
                                        <button type="button" class="text-xs font-semibold text-blue-600 hover:text-blue-800 focus:outline-none">Detail</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
        ...
        <div class="grid grid-cols-1 gap-4 md:hidden">
            ...
            <div class="bg-white space-y-3 p-4 rounded-lg shadow">
                ...
                <div class="text-sm">
                    <span class="
                @if(strtolower($cuti->status_ajuan) == 'diproses')
                    p-1 bg-yellow-200 text-yellow-700 uppercase font-bold text-wider rounded-xl
                @elseif(strtolower($cuti->status_ajuan) == 'disetujui')
